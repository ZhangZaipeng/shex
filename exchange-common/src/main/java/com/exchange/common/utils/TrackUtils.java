  ...
  static {
    ...
    if (address == null) {
      ...
      ipAddressPart = StringUtils
          .fixStringLen(Integer.toHexchangeString(ipArray[1]).toUpperCase(), '0', 2)
          .concat(StringUtils.fixStringLen(Integer.toHexchangeString(ipArray[2]).toUpperCase(), '0', 2))
          .concat(StringUtils.fixStringLen(Integer.toHexchangeString(ipArray[3]).toUpperCase(), '0', 2));
    }
