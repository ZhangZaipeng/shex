...
import com.shex.common.utils.StringUtils;
import com.shex.platform.YvanUtil;
import com.shex.platform.login.*;
import com.shex.platform.springmvc.WebContext;
...
public abstract class CookieIdentityValidator implements IdentityValidator {
   ...
   * 会话cookie 超时时间(以秒为单位)
   */
  private static final int PRINCIPALCOOKIE_MAX_AGE = 30 * 60;
  /**
   * 持久cookie 超时时间(以秒为单位)
   */
  private static final int VISITORCOOKIE_MAX_AGE = 30 * 60;
