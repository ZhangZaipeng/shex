    ...
    static {
        ...
        if (address == null) {
            ...
            ipAddressPart = StringUtils
                .fixStringLen(Integer.toHexString(ipArray[1]).toUpperCase(), '0', 2).concat(StringUtils.fixStringLen(Integer.toHexString(ipArray[2]).toUpperCase(), '0', 2)).concat(StringUtils.fixStringLen(Integer.toHexString(ipArray[3]).toUpperCase(), '0', 2));
        }
