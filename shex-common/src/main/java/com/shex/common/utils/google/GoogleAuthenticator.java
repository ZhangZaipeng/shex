package com.shex.common.utils.google;
...
public class GoogleAuthenticator {
    ...
    public static void main(String[] args) {
        ...
        String qrcodeUrl = GoogleAuthenticator.getQRBarcodeURL("282354184@qq.com", "mexc.com", secret);
        System.out.println(qrcodeUrl);*/
        GoogleAuthenticator g = new GoogleAuthenticator();
        System.out.println(g.checkCode("LJYFEHTY6TEINMU7",946493L));
    }
