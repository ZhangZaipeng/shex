...
public final class TrackUtils {
  ...
  static {
    ...
    pidPart = StringUtils.fixStringLen(Integer.toHexString(pid).toUpperCase(), '0', 4);
    ...
    if (address == null) {
      ...
      ipAddressPart = StringUtils
          .fixStringLen(Integer.toHexString(ipArray[1]).toUpperCase(), '0', 2)
          .concat(StringUtils.fixStringLen(Integer.toHexString(ipArray[2]).toUpperCase(), '0', 2))
          .concat(StringUtils.fixStringLen(Integer.toHexString(ipArray[3]).toUpperCase(), '0', 2));
    }
  ...
  public static final String generateChannelFlowNo(String systemCode) {
    ...
    String increaseHex = StringUtils
        .fixStringLen(Integer.toHexString(increaseNo).toUpperCase(), '0', 5);
  ...
  public static void main(String[] args) {
    ...
    TrackUtils.generateChannelFlowNo("ERB");
  }
}
